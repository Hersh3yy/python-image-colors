...
def insert_sql_command(color_info, table_type, color_space, closest_function, parent_ids, colors, color_space_fn):
    hex, name = color_info
    ...
    closest_color = closest_function((r, g, b), colors, color_space_fn, color_space)
    ...
    with open('insert_commands.sql', 'a') as f:
        f.write(sql_command)
...
for color in parent_colors:
    hex, name = color
    insert_sql_command(color, "parent_colors", args.color_space, closest_function, parent_ids, parent_colors_dict, color_space_functions.get(args.color_space, lambda x: x))

for hex, name in parent_colors:
    insert_sql_command((hex, name), "parent_colors", closest_color_in_space, parent_ids, parent_colors_dict, hex_to_rgb)
...
for hex, name in color_names:
    insert_sql_command((hex, name), "color_names", closest_color_in_space, parent_ids, parent_colors_dict, hex_to_rgb)
